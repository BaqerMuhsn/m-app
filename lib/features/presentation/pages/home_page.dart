...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarTop = _hideHomeSections ? topInset : topInset + _appBarHeight;

    return GradientScaffold(
      appBar: _hideHomeSections
          ? null
          : PreferredSize(
              ...
              child: AppBar(
                backgroundColor:
                    _isScrolled ? const Color(0xFFFFFFFF) : Colors.transparent,
      ...
      bottomNavigationBar:
          _hideHomeSections ? null : const CustomBottomNav(),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Padding(padding: const EdgeInsets.only(top: 20), child: Container(
                      height: 48,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              onTap: () {
                                if (!_hideHomeSections) {
                                  setState(() => _hideHomeSections = true);
                                }
                              },
